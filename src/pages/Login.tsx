...
import { GOOGLE_OAUTH_URL } from '@/config/oauth';
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div className="relative my-4 flex items-center gap-2">
                  <span className="flex-1 border-t border-[#402E2A]/20" />
                  <span className="text-xs text-[#402E2A]/60">veya</span>
                  <span className="flex-1 border-t border-[#402E2A]/20" />
                </div>
                ...
                <button
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-lg border border-[#402E2A]/20 bg-white px-4 py-3 text-sm font-medium text-[#402E2A] transition hover:bg-[#402E2A]/5"
                >
